...
public class LinkedBinarySearchTreeTest {
    ...
    void predecessors1() {
        ...
        assertEquals(predecesores.get(0),pos[2]);
        assertEquals(predecesores.get(1),pos[1]);
    ...
    void predecessors2() {
        ...
        assertEquals(predecesores.get(5),pos[3]);
    ...
    void predecessors3() {
        ...
        assertEquals(predecesores.get(1),pos[4]);
    ...
    void findRange1(){
        ...
        assertEquals(range.get(0),pos[4]);
    ...
    void findRange3(){
        ...
        assertEquals(range.get(3),pos[3]);
