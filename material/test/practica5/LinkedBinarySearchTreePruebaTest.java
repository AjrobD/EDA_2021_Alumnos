...
import material.tree.binarysearchtree.LinkedBinarySearchTreePrueba;
...
public class LinkedBinarySearchTreePruebaTest {
    private LinkedBinarySearchTreePrueba<Integer> tree;
    ...
    void setUp() {
        tree = new LinkedBinarySearchTreePrueba<Integer>();
        pos = new Position[16];
        pos[4] = tree.insert(4);
        pos[2] = tree.insert(2);
        pos[3] = tree.insert(3);
    ...
    void findRange1(){
        ...
        assertEquals(range.get(0),pos[2]);
        assertEquals(range.get(1),pos[3]);
    ...
    void findRange6(){
        ...
        assertEquals(range.get(3),pos[4]);
        assertEquals(range.get(4),pos[5]);
        assertEquals(range.get(5),pos[6]);
        assertEquals(range.get(6),pos[7]);
